    ...
    //else
    {
        while (1)
        {
...
#endif
            {
                ...
                qglTexCoordPointer(2, GL_FLOAT, 0, texture);
                ...
                do
                {
                    ...
                    *pColor++ = alpha;
                    ...
                    //*pVert++ = verts->v[2];
                    //verts++;
                    *pVert++ = s_lerped[index_xyz][0];
                    *pVert++ = s_lerped[index_xyz][1];
                    *pVert++ = s_lerped[index_xyz][2];
                } while (--c);
            }

            qglDrawArrays(primitive, 0, count);

...
//sstatic void ( APIENTRY * dllIndexsv )(const GLshort *c);
...
static void ( APIENTRY * dllLightx )(GLenum light, GLenum pname, GLfixed pararm);
...
{
// XXX: fprintf( glw_state.log_fp, "*** R_BeginFrame ***\n" );
}
